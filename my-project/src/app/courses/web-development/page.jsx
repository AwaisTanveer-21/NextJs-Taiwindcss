...
const courseData = {
  ...
  description: "Master modern web development from scratch. Learn HTML, CSS, JavaScript, React, Next.js, Node.js, and MongoDB to become a full-stack developer.",
  learningOutcomes: [
  ...
  curriculum: [
    { week: "Week 1-2", topic: "HTML5 & CSS3 Fundamentals" },
    { week: "Week 3-4", topic: "JavaScript & DOM Manipulation" },
    { week: "Week 5-6", topic: "React.js & State Management" },
    { week: "Week 7-8", topic: "Next.js & Server-side Rendering" },
    { week: "Week 9-10", topic: "Node.js & Express.js" },
    { week: "Week 11-12", topic: "MongoDB & Database Design" },
    { week: "Week 13-14", topic: "Authentication & Security" },
    { week: "Week 15-16", topic: "Deployment & Final Projects" },
  ],
  requirements: [
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
            <div className="flex flex-wrap items-start justify-between">
              ...
              <div className="bg-white/20 backdrop-blur-sm p-6 rounded-xl mt-4 lg:mt-0">
                ...
                <Link
                  href="/contact"
                  className="block mt-3 bg-yellow-400 text-blue-900 px-6 py-2 rounded-full text-center font-semibold hover:bg-yellow-300 transition"
                >
                  Enroll Now
                </Link>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-6 border-b">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">{courseData.rating}⭐</div>
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Link
                  href="/schedule"
                  className="block bg-gray-200 text-gray-700 text-center py-3 rounded-xl font-semibold hover:bg-gray-300 transition"
                >
                  View Schedule
                </Link>
              </div>
