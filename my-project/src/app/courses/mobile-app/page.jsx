...
export default function MobileAppCourse() {
  const courseData = {
    ...
    description: "Learn to build cross-platform mobile apps using React Native and Flutter. Develop iOS and Android applications with a single codebase.",
    learningOutcomes: [
    ...
    curriculum: [
      { week: "Week 1-2", topic: "Mobile App Fundamentals" },
      { week: "Week 3-4", topic: "React Native Basics" },
      { week: "Week 5-6", topic: "React Native Advanced" },
      { week: "Week 7-8", topic: "Flutter Fundamentals" },
      { week: "Week 9-10", topic: "State Management" },
      { week: "Week 11-12", topic: "API Integration" },
      { week: "Week 13-14", topic: "App Deployment" },
      { week: "Week 15-16", topic: "Final Projects" },
    ],
    requirements: [
