...
export default function DataScienceCourse() {
  const courseData = {
    ...
    description: "Master Data Science and AI with Python, Machine Learning, Deep Learning, and Natural Language Processing. Become a data scientist with hands-on projects.",
    learningOutcomes: [
    ...
    curriculum: [
      { week: "Week 1-2", topic: "Python for Data Science" },
      { week: "Week 3-4", topic: "Data Analysis & Visualization" },
      { week: "Week 5-6", topic: "Machine Learning Fundamentals" },
      { week: "Week 7-8", topic: "Advanced ML Algorithms" },
      { week: "Week 9-10", topic: "Deep Learning Basics" },
      { week: "Week 11-12", topic: "Neural Networks & TensorFlow" },
      { week: "Week 13-14", topic: "NLP & Computer Vision" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-6 border-b">
            ...
            <div className="flex items-center gap-3">
              <FiCpu className="text-green-600 text-xl" />
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Link href="/contact" className="block bg-green-600 text-white text-center py-3 rounded-xl font-semibold hover:bg-green-700 transition">
                  Enroll Now
                </Link>
