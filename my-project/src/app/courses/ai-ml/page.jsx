...
export default function AIMLCourse() {
  const courseData = {
    ...
    rating: 4.9,
    category: "AI",
    description: "Master Artificial Intelligence and Machine Learning. Learn neural networks, deep learning, computer vision, and natural language processing with TensorFlow and PyTorch.",
    learningOutcomes: [
      "Master Python for AI and ML",
    ...
    curriculum: [
      { week: "Week 1-2", topic: "Python for AI/ML" },
      { week: "Week 3-4", topic: "Machine Learning Fundamentals" },
      { week: "Week 5-6", topic: "Neural Networks Basics" },
      { week: "Week 7-8", topic: "Deep Learning with TensorFlow" },
      { week: "Week 9-10", topic: "Computer Vision" },
      { week: "Week 11-12", topic: "Natural Language Processing" },
      { week: "Week 13-14", topic: "Model Deployment" },
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Link href="/contact" className="block bg-indigo-600 text-white text-center py-3 rounded-xl font-semibold hover:bg-indigo-700 transition">
                  Enroll Now
                </Link>
